...
public class Library {
	...
	public Library(Library libraryToImport, String[] listOfNames) {
		...
		for(String e: listOfNames){
			if(libraryToImport.getLib().containsKey(e)){
				lib.put(e, new Playlist(libraryToImport.getLib().get(e)));
			}
		}
	}
	...
	public HashMap<String, Playlist> getLib(){
		return lib;
	}
